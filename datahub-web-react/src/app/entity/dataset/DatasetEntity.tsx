...
import { SidebarVisualizeWithSupersetSection } from '../shared/containers/profile/sidebar/SidebarVisualizeWithSupersetSection';
...
export class DatasetEntity implements Entity<Dataset> {
    ...
    renderProfile = (urn: string) => (
        <EntityProfile
            ...
            sidebarSections={[
                // Maybe add a check here (like for below) to only show this if we know the dataset exists?
                {
                    component: SidebarVisualizeWithSupersetSection,
                },
                {
